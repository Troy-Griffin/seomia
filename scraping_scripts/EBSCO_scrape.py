...
if __name__ == "__main__":
    ...
    wait.until(
        EC.visibility_of_element_located(
            (
                By.XPATH,
                "//button[contains(@class,'osano-cm-dialog__close osano-cm-close')]",
            )
        )
    )
    database_button = driver.find_element(
        By.XPATH, "//button[contains(@class,'osano-cm-dialog__close osano-cm-close')]"
    )
    ...
    wait.until(
        EC.visibility_of_element_located(
            (
                By.XPATH,
                "/html[1]/body[1]/div[2]/div[1]/div[2]/div[2]/div[2]/div[2]/div[2]/main[1]/div[1]/div[1]/div[1]/div[1]/form[1]/div[1]/div[1]/div[1]/fieldset[1]/div[1]/div[1]/div[1]/div[1]/div[1]/input[1]",
            )
        )
    )
    ...
    while k == 0:
        wait.until(
            EC.visibility_of_element_located(
                (By.XPATH, "//button[@data-auto = 'show-more-button']")
            )
        )
